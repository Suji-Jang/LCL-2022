...
# write.csv(POD.med.CA.Default,"POD_CADefault_Median.csv",row.names=FALSE)
# write.csv(POD.sens01.CA.Default,"POD_CADefault_Sens01.csv",row.names=FALSE)
...
# write.csv(AI.CA.Default.med,"AI_CADefault_Median.csv",row.names=FALSE)
# write.csv(AI.CA.Default.sens01,"AI_CADefault_Sens01.csv",row.names=FALSE)