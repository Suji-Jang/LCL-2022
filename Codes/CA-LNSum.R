...
# write.csv(POD.med.CA.LNSum,"POD_CALNSum_Median.csv",row.names=FALSE)
# write.csv(POD.sens01.CA.LNSum,"POD_CALNSum_Sens01.csv",row.names=FALSE)
...
# write.csv(AI.CA.LNSum.med,"AI_CALNSum_Median.csv",row.names=FALSE)
# write.csv(AI.CA.LNSum.sens01,"AI_CALNSum_Sens01.csv",row.names=FALSE)