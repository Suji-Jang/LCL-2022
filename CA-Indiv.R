...
# write.csv(POD.med.CA.Indiv,"POD_CAIndiv_Median.csv",row.names=FALSE)
# write.csv(POD.sens01.CA.Indiv,"POD_CAIndiv_Sens01.csv",row.names=FALSE)
...
# write.csv(AI.CA.Indiv.med,"AI_CAIndiv_Median.csv",row.names=FALSE)
# write.csv(AI.CA.Indiv.sens01,"AI_CAIndiv_Sens01.csv",row.names=FALSE)